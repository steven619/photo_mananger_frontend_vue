<template>
  <AreaCascader
    v-model="modelVal"
    :area="optionsData"
    :check-strictly="mergeConfig.checkStrictly"
    style="width: 100%"
  />
</template>
...
import AreaCascader from './area_select.vue'
...
export default {
  ...
  computed: {
    ...
    optionsData() {
      return (this.mergeConfig.enumSource && this.mergeConfig.enumSource.length > 0) ? this.mergeConfig.enumSource : area
    }
  },
